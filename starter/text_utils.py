"""Shared text normalization helpers for the conversational search agent."""
...
STOPWORDS = {
    ...
    "would", "you", "looking", "have", "has", "do", "does", "not",
    "no", "about", "additional", "what", "matters", "need", "key",
    "requirement", "preference", "prioritize",
}
