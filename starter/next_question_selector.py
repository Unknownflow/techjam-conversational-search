"""Adaptive next-question selection for narrowing search results."""
...
class NextQuestionSelector:
        ...
        "size": frozenset(
            {
                ...
                "plus", "petite", "wide", "narrow", "slim", "oversized",
            }
        ),
        "style": frozenset(
            {
                "casual", "classic", "formal", "modern", "vintage", "boho",
                "sport", "athletic", "relaxed", "fitted", "slim", "loose",
                "sleeveless", "hooded",
            }
        ),
        "use_case": frozenset(
            {
                "running", "walking", "hiking", "work", "travel", "wedding",
                "party", "gym", "outdoor", "winter", "summer", "school",
                "sleep", "swim",
            }
        ),
    }
    ...
    PROMPTS = {
        ...
        "feature": (
            "Is there a particular feature or construction detail you care about?"
        ),
    ...
    def score(
        ...
        pool_bonus = min(0.10, math.log1p(total) / 100.0) if total else 0.0
        ...
        scores["other"] = min(0.99, combined + 0.04)
    ...
    def choose(cls, state: dict) -> tuple[str | None, str, float]:
        ...
        if (
            ...
            and utility < available["feature"] + 0.08
        ):
